...
export default defineComponent({
  ...
  setup(props: InputProps, { emit, slots }) {
    ...
    // 设置原始值
    const nativeInputValue = ref(modelValue)
    // 给当前input赋值
    ...
    const changeInput = (e: Event) => {
      ...
      nativeInputValue.value = targetVal
      setNativeInputValue()
